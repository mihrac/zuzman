...
class SubCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sub_category" do
    assert_difference('SubCategory.count') do
      post sub_categories_url, params: { sub_category: { category_id: @sub_category.category_id, sub_cat_name: @sub_category.sub_cat_name } }
    end
  ...
  test "should update sub_category" do
    patch sub_category_url(@sub_category), params: { sub_category: { category_id: @sub_category.category_id, sub_cat_name: @sub_category.sub_cat_name } }
